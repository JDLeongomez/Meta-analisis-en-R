...
```{=tex}
\newtcolorbox[auto counter]{Box2}[2][]{
...
knit_hooks$set(output = function(x, options){
  ...
  return(paste("\\begin{Box2}{Consola de R: Output~\\thetcbcounter}
                \\begin{footnotesize}
                \\begin{verbatim}", 
               x,
               "\\end{verbatim}
...
[![Investigación Abierta](Logo-IA-Rectangulo.png)](https://www.youtube.com/c/InvestigaciónAbierta){width=40%}

\vfill

----------------------

**Cita éste trabajo como:**
...
Primero, primero, debemos cargar los paquetes que usaremos, incluyendo `{metafor}` y `{robumeta}` para hacer metaánálisis, así como `{dplyr}` para manipular y organizar la base de datos.
