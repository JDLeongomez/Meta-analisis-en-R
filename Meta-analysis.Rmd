...
knit_hooks$set(output = function(x, options){
  ...
  return(paste("\\vspace{3mm}
                \\begin{mdframed}[linecolor = gray,
                                  linewidth = 1.5pt,
                                  frametitle={\\textcolor{gray}{Salida de la consola de R:}}]
                \\begin{verbatim}", 
               x,
...
Por esto, vamos a transformar los coeficientes *r* de Pearson a *z* de Fisher, que no tienen este problema. Usaré la función `escalc` del paquete `metafor`.
...
[^1]: $\tau^2$ es una estimación de la varianza de los tamaños de los efectos reales entre los estudios meta-analizados. Se usa, principalmente, para asignar pesos a cada estudio. Para más información, ver Borenstein et al. [-@borensteinIdentifyingQuantifyingHeterogeneity2009].
