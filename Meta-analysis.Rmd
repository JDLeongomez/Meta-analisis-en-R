...
\newenvironment{theo}[1][]{%
  ...
  \mdfsetup{innertopmargin=7pt,linecolor=blue!20,linewidth=2pt,topline=true,
...
knit_hooks$set(output = function(x, options){
  ...
  return(paste("\\begin{theo}[nobreak=true]
                \\begin{verbatim}", 
               x,
               "\\end{verbatim}\\end{theo}"))
})
library(robumeta)
library(metafor)
library(dplyr)
