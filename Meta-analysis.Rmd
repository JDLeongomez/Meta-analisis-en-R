...
Para esto, debemos tener instalado el paquete `devtools` [^13], y usar la función `install_github` que nos permite instalar paquetes directamente desde GitHub.

[^13]: En Windows, instalar `devtools` puede requerir instalar la versión de [`Rtools`](https://cran.r-project.org/bin/windows/Rtools/) correspondiente a tu versión de R. Por ejemplo, si tu versión de R es 4.2.3, debes descargar e instalar la versión 4.2 de [`Rtools`](https://cran.r-project.org/bin/windows/Rtools/).
