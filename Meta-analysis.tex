...
\section{Meta-análisis de correlación con moderador}\label{met-moderation}}
...
\subsection{\texorpdfstring{Método \emph{trim and fill} (recorte y relleno)}{Método trim and fill (recorte y relleno)}}\label{trim-fill}}
...
\caption{\label{fig:unnamed-chunk-27}En negro los estudios meta-analizados; en blanco, los estudios \emph{rellenados}.}
\end{figure}
...
\subsection{Estimación del modelo de función de peso}\label{estimaciuxf3n-del-modelo-de-funciuxf3n-de-peso}}
