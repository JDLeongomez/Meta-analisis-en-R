...
\begin{ROut}{Consola de R: Output~\thetcbcounter}
     ...
     cr.lb   pred     se   ci.lb ci.ub    pi.lb pi.ub
     <dbl>  <dbl>  <dbl>   <dbl> <dbl>    <dbl> <dbl>
1  0.00921 0.226  0.0713  0.0863 0.366  0.00921 0.443
2  0.00551 0.202  0.0538  0.0966 0.307  0.00551 0.398
3 -0.00455 0.178  0.0389  0.102  0.254 -0.00455 0.360
4 -0.0225  0.154  0.0307  0.0937 0.214 -0.0225  0.330
5 -0.0491  0.130  0.0344  0.0625 0.197 -0.0491  0.309
6 -0.0840  0.106  0.0472  0.0134 0.198 -0.0840  0.296
7 -0.126   0.0819 0.0639 -0.0434 0.207 -0.126   0.290
 \end{verbatim}
                \end{footnotesize}
                \end{ROut}
...
\NormalTok{pred.res.contr }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(res.contr, }\AttributeTok{newmods =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{select}\NormalTok{(}\DecValTok{9}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{8}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(dat, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ controls, }\AttributeTok{y =}\NormalTok{ yi)) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_color\_viridis\_c}\NormalTok{(}\AttributeTok{option =} \StringTok{"inferno"}\NormalTok{, }\AttributeTok{guide =} \StringTok{"legend"}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{color =} \StringTok{"Tamaño de muestra"}\NormalTok{,}
       \AttributeTok{size =} \StringTok{"Tamaño de muestra"}\NormalTok{) }\SpecialCharTok{+}
