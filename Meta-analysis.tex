...
1      20 0.22601916 0.07127543  0.08632189 0.3657164  0.009206504 0.4428318
2      30 0.20199184 0.05378900  0.09656735 0.3074163  0.005505903 0.3984778
3      40 0.17796453 0.03891725  0.10168811 0.2542409 -0.004547093 0.3604761
4      50 0.15393721 0.03072582  0.09371572 0.2141587 -0.022468650 0.3303431
5      60 0.12990990 0.03437769  0.06253086 0.1972889 -0.049065895 0.3088857
6      70 0.10588258 0.04719960  0.01337307 0.1983921 -0.083986872 0.2957520
7      80 0.08185527 0.06389057 -0.04336795 0.2070785 -0.125926480 0.2896370
 \end{verbatim}
                \end{footnotesize}
                \end{ROut}
...
\begin{itemize}
\item
  \textbf{\texttt{meanage}}: edad promedio de los participantes de los estudios metaanalizados
\item
...
\item
  \textbf{\texttt{se}} (\emph{standard error}): error estándar del efecto predicho
\item
  \textbf{\texttt{ci.lb}} (\emph{confidence interval lower bound}): límite inferior del intervalo de confianza al 95\% del efecto predicho
\item
  \textbf{\texttt{ci.ub}} (\emph{confidence interval upper bound}): límite superior del intervalo de confianza al 95\% del efecto predicho
\item
  \textbf{\texttt{pi.lb}} (\emph{prediction interval lower bound}): límite inferior del intervalo de predicción, y
\item
  \textbf{\texttt{pi.ub}} (\emph{prediction interval upper bound}): límite superior del intervalo de predicción
\end{itemize}

Las columnas \texttt{age} (edad) y \texttt{pred} (efecto predicho), me muestran que para estudios donde los participantes son más jóvenes en promedio, se esperaría una correlación más fuerte; por ejemplo, mientras que para estudios con personas de 20 años de edad en promedio se esperaría una correlación de \emph{z} = 0.226, para estudios participantes con una edad promedio de 80 años, el modelo estima un efecto de \emph{z} = 0.082. En otras palabras, en nuestra muestra de estudios, la asociación entre concienciación y adherencia a la medicación tiende a reducirse ligeramente con la edad promedio de la muestra.
...
1     none 0.17875537 0.02077498  0.13803716 0.21947359  0.13803524 0.21947551
2 multiple 0.01666156 0.02956599 -0.04128671 0.07460983 -0.04128806 0.07461118
 \end{verbatim}
                \end{footnotesize}
                \end{ROut}
