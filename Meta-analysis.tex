...
\hypertarget{interpretaciuxf3n-de-los-resultados-del-meta-anuxe1lisis}{%
\subsection{Interpretación de los resultados del meta-análisis}\label{interpretaciuxf3n-de-los-resultados-del-meta-anuxe1lisis}}
...
Cualquiera de estas opciones nos da un valor de \emph{r} = 0.1487872, muy similar al obtenido (\emph{z} = 0.1499). Siempre se puede hacer los mismo con el error estándar y los límites del intervalo de confianza al 95\% (todos valores en \emph{z} de Fisher, pues fue el tamaño de efecto que meta-analizamos), y reportar todos estos resultados en coeficientes de correlación \emph{r} de Pearson.
